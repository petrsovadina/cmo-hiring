...
**YOU ARE IN: `cmo/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/cmo/` (rig root) or other directories
...
**Your mail address:** `cmo/polecats/chrome`
**Your rig:** cmo
**Your Witness:** `cmo/witness`
...
| Ask Witness for help | `gt mail send cmo/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`cmo/witness`) when:
...
```bash
gt mail send cmo/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
